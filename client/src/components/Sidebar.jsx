...
import { Bot, LayoutDashboard, Clock, UserCircle, LogOut, X } from 'lucide-react';
...
const Sidebar = ({ onLogout, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed top-0 left-0 h-screen w-64 bg-[#0d1117] border-r border-white/10 flex flex-col z-50
